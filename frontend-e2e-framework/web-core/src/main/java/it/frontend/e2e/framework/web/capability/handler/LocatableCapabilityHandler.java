...
public class LocatableCapabilityHandler extends AbstractCapabilityHandler<Locatable> {

    public LocatableCapabilityHandler(IWebPresentationApiAdapter adapter) {
