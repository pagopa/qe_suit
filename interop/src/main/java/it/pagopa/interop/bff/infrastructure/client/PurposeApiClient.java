...
public class PurposeApiClient extends RestService {
    ...
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.Purposes, Purpose> getProducerPurposes(Integer offset, Integer limit, String q, List<UUID> eservicesIds, List<UUID> consumersIds, List<it.pagopa.interop.generated.openapi.clients.bff.model.PurposeVersionState> states) {
        return super.readAll(
            () -> api.getProducerPurposesWithHttpInfo(offset, limit, q, eservicesIds, consumersIds, states),
            mapper::toDomainList
        );
    }
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.Purposes, Purpose> getConsumerPurposes(Integer offset, Integer limit, String q, List<UUID> eservicesIds, List<UUID> producersIds, List<it.pagopa.interop.generated.openapi.clients.bff.model.PurposeVersionState> states) {
        return super.readAll(
            () -> api.getConsumerPurposesWithHttpInfo(offset, limit, q, eservicesIds, producersIds, states),
            mapper::toDomainList
        );
    }
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.Purposes, Purpose> getRiskAnalysisAssignments(Integer offset, Integer limit, List<UUID> eservicesIds, List<it.pagopa.interop.generated.openapi.clients.bff.model.RiskAnalysisSigningState> signingStates) {
        return super.readAll(
