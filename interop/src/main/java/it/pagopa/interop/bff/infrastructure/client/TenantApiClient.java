...
public class TenantApiClient extends RestService {
    ...
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.CompactOrganizations, Tenant> getConsumers(Integer offset, Integer limit, String q) {
        return super.readAll(
            () -> api.getConsumersWithHttpInfo(offset, limit, q),
            mapper::toDomainList
        );
    }
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.CompactOrganizations, Tenant> getProducers(Integer offset, Integer limit, String q) {
        return super.readAll(
    ...
    public TestChain<Void, Tenant> revokeVerifiedAttribute(UUID tenantId, UUID attributeId, it.pagopa.interop.generated.openapi.clients.bff.model.RevokeVerifiedAttributeRequest revokeVerifiedAttributeRequest) {
        return super.read(
    ...
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.Tenants, Tenant> getTenants(Integer limit, String name, List<it.pagopa.interop.generated.openapi.clients.bff.model.TenantFeatureType> features) {
        return super.readAll(
