...
public class AttributeApiClient extends RestService {
    ...
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.Attributes, Attribute> getAttributes(String q, String origin, Integer limit, Integer offset, List<it.pagopa.interop.generated.openapi.clients.bff.model.AttributeKind> kinds) {
