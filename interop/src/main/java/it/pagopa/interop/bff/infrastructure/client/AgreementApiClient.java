...
public class AgreementApiClient extends RestService {
    ...
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.CompactOrganizations, Agreement> getAgreementsProducers(Integer offset, Integer limit, String q) {
        return super.readAll(
            () -> api.getAgreementsProducersWithHttpInfo(offset, limit, q),
            mapper::toDomainList
        );
    }
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.CompactOrganizations, Agreement> getAgreementsConsumers(Integer offset, Integer limit, String q) {
        return super.readAll(
    ...
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.CompactEServicesLight, Agreement> getAgreementsProducerEServices(Integer offset, Integer limit, String q) {
        return super.read(
            () -> api.getAgreementsProducerEServicesWithHttpInfo(offset, limit, q),
            mapper::toDomain
        );
    }
    public TestChain<it.pagopa.interop.generated.openapi.clients.bff.model.CompactEServicesLight, Agreement> getAgreementsConsumerEServices(Integer offset, Integer limit, String q) {
        return super.read(
