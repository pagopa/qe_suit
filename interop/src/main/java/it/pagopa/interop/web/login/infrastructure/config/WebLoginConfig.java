package it.pagopa.interop.web.login.infrastructure.config;

import io.cucumber.spring.ScenarioScope;
import it.frontend.e2e.framework.web.WebPresentationGateway;
import it.pagopa.interop.web.login.infrastructure.page.DashboardPage;
import it.pagopa.interop.web.login.infrastructure.page.LoginPage;
