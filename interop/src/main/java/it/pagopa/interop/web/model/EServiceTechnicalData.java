...
public record EServiceTechnicalData(
        String aud,
    ...
    public static EServiceTechnicalData buildEmpty() {
        return new EServiceTechnicalData(null, null, null, new AsyncExchangeProperties(), null);
    }
