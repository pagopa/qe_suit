...
public record WebEServiceTechnicalData(
        String aud,
    ...
    public static WebEServiceTechnicalData buildEmpty() {
        return new WebEServiceTechnicalData(null, null, null, new AsyncExchangeProperties(), null);
    }
