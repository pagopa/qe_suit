package it.pagopa.interop.web.dev_tools.infrastructure.page;

import it.frontend.e2e.framework.annotation.location.web.Url;
import it.frontend.e2e.framework.annotation.selector.XPath;
import it.frontend.e2e.framework.web.capability.core.Readable;
import it.frontend.e2e.framework.web.domain.Page;
import it.pagopa.interop.web.dev_tools.infrastructure.page.component.DebugClientAssertionSection;
import it.pagopa.interop.web.dev_tools.infrastructure.page.component.SimulatoreOttenimentoTokenSection;
