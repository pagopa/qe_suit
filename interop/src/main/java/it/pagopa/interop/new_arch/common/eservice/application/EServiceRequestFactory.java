...
import it.pagopa.interop.new_arch.common.eservice.application.command.EServiceRiskAnalysisCreationCommand;
...
public interface EServiceRequestFactory extends Plugin<Channel> {
    ...
    EServiceRiskAnalysisCreationCommand creationLatestRiskAnalysisCommand();
}
