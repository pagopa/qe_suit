...
public class WebDevToolsService implements DevToolsService {
    ...
    public ClientAssertionValidationResult validate(ClientAssertion clientAssertion, Client client) {
        return internalValidate(clientAssertion.getClientAssertion(), client.getId().toString(), null);
    }

    @Override
    public ClientAssertionValidationResult validate(ClientAssertion clientAssertion, Client client, DPoPProof proof) {
        return internalValidate(clientAssertion.getClientAssertion(), client.getId().toString(), proof.getJwt());
    }

    @Override
    public ClientAssertionValidationResult validate(String clientAssertion, String client, String proof) {
        return internalValidate(clientAssertion, client, proof);
    }


    private ClientAssertionValidationResult internalValidate(String clientAssertion, String clientId, String dPoPProof) {
