...
public class PageType {
    ...
    @ParameterType("LoginPage|LogoutPage|Dashboard|APIKey|NewAPIKey|Statistics|PlatformStatus|NotificationDetails|CreateNotification|BackstageProfile")
    public Class<? extends Page> page(String page) {
        return switch (page) {
            case "LoginPage" -> OneIdPage.class;
            case "LogoutPage" -> LogoutPage.class;
